    ...
    for col, (emoji, title, desc) in zip(columns, boxes):
        with col:
            ...
            <div class="metric-box">
                ...
                <div style="font-weight: 600; margin-bottom: 0.3em; color: #222;">{title}</div>
...
def render_model_comparison():
    ...
    with col2:
        ...
        **Advantages:**
        - ✅ Superior accuracy (97.70% vs 72.87%)
    ...
    **MobileNetV2 was selected as the final model** because it achieved substantially better 
    classification performance (97.70% vs 72.87% accuracy) on the unseen test dataset. 
...
def render_about():
    ...
    **Why MobileNetV2?**
    - Substantially better accuracy (97.70% vs 72.87%)
